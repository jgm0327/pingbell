...
public class IncidentController {
    ...
    public List<IncidentResponse> getIncidents(@AuthenticationPrincipal AuthenticatedMember member) {
        return incidentQueryService.getIncidents(member.id());
    }
    ...
    public List<IncidentResponse> getMonitorIncidents(@PathVariable Long monitorId) {
        return incidentQueryService.getMonitorIncidents(monitorId);
    }
}
