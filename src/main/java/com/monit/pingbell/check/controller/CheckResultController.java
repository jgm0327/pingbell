...
public class CheckResultController {
    ...
    @GetMapping("/summary")
    public MonitorCheckSummaryResponse getMonitorCheckSummary(@PathVariable Long monitorId) {
        return checkResultQueryService.getMonitorCheckSummary(monitorId, LocalDateTime.now());
    }
